            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  <h2>Get In Touch</h2>
                  <form action="https://getform.io/f/ab3b3689-67d5-47cb-bb2c-fe24254a61df" method="POST" >
                    <Row>
                      ...
                      <Col size={12} sm={6} className="px-1">
                        <input type="tel"  name="number" value={formDetails.phone} placeholder="Phone No." onChange={(e) => onFormUpdate('phone', e.target.value)} />
                      </Col>
